          ...
          <Row>
            <Col>
              <div className="btech-container">
                ...
                <div className="btech-item">
                <h3 className="text-capitalize text-center mb-4 mt-4">Curriculum</h3>
                  <ul>
                    <li><a href={EXTC_Scheme_2021_25} target="_blank"><h2>For 2021-2025 Batch</h2></a></li>
                    <li><a href={EXTC_Scheme_2022_26} target="_blank"><h2>For 2022-2026 Batch</h2></a></li>
                  </ul>
                </div>
              </div>
            </Col>
