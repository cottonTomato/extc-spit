...
import EXTC_Scheme_2021_25 from "../../pdfs/btech_syllabus/BTECH_EXTC_2021-2025_Scheme_modified.pdf";
import EXTC_Scheme_2022_26 from "../../pdfs/btech_syllabus/BTECH_EXTC_2022-2026_Scheme.pdf";
              ...
              <div className="btech-container">
                <div className="btech-item">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href={SEPDF} target="_blank">
                        <h2>SE Term 1 2024-25</h2>
                      </a>
                    </li>
                    <li>
                      <a href={TEPDF} target="_blank">
                        <h2>TE Term 1 2024-25</h2>
                      </a>
                    </li>
                    <li>
                      <a href={BEPDF} target="_blank">
                ...
                <div className="btech-item">
                  ...
                  <ul>
                    <li>
                      <a href={EXTC_Syllabus_SEM_III} target="_blank">
                        <h2>FE Class (EXTC 2021-2025)</h2>
                      </a>
                    </li>
                    <li>
                      <a href={EXTC_SE_Syllabus} target="_blank">
                        <h2>SE Class (EXTC 2021-2025)</h2>
                      </a>
                    </li>
                    <li>
                      <a href={EXTC_Syllabus_SEM_V} target="_blank">
                        <h2>TE Class (EXTC 2021-2025)</h2>
                      </a>
                    </li>
                    <li>
                      <a href={EXTC_Syllabus_SEM_VII} target="_blank">
                ...
                <div className="btech-item">
                  ...
                  <ul>
                    <li>
                      <a href={EXTC_Scheme_2021_25} target="_blank">
                        <h2>For 2021-2025 Batch</h2>
                      </a>
                    </li>
                    <li>
                      <a href={EXTC_Scheme_2022_26} target="_blank">
