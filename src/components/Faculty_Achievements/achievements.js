...
export const FacultyAchievementsData = {
  sponsoredProjects: [
    ...
    { sr: 9, achievement: "Dr. Sujata Kulkarni received Publication Grant (postdoctoral) from Research center of Swami Ramnandtheerth Marathwada University, Nanded." },
    { sr: 10, achievement: "Dr. Sujata Kulkarni received a Publication Grant (postdoctoral) of USD250 from IEEE-AESS student chapter." },
    ...
    { sr: 12, achievement: "Dr. Sujata Kulkarni received Grant of approx. 40,000/- for sponsored one week faculty development program (Capacity Building program) on “Blockchain Technology: Future of Cybersecurity for 2023 - 24. IEEE Bombay section" },
    { sr: 13, achievement: "Dr. Sujata Kulkarni received Grant of approx. 13,000/- for Best Practices from IEEE Stem Activity." },
    { sr: 14, achievement: "Dr. Prashant Kasambe and Prof. Najib Ghatte received grant of 2 Lakhs from AICTE-SPICES in 2021-22" },
  ],
  patentsGranted: [
